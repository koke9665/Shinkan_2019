...
public class bl_MiniMapEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (EditorGUILayout.BeginFadeGroup(GeneralAnim.faded))
        {
            ...
            script.ToogleKey = (KeyCode)EditorGUILayout.EnumPopup("Toggle Key", script.ToogleKey);
            script.m_Type = (bl_MiniMap.RenderType)EditorGUILayout.EnumPopup("Draw Mode", script.m_Type);
            script.m_Mode = (bl_MiniMap.RenderMode)EditorGUILayout.EnumPopup("Render Mode", script.m_Mode);
        ...
        if (EditorGUILayout.BeginFadeGroup(ReferencesAnim.faded))
        {
            ...
            script.ItemPrefab = EditorGUILayout.ObjectField("Icon Prefab", script.ItemPrefab, typeof(GameObject), allowSceneObjects) as GameObject;
            ...
            script.MMUIRoot = EditorGUILayout.ObjectField("UI Root", script.MMUIRoot, typeof(RectTransform), allowSceneObjects) as RectTransform;
