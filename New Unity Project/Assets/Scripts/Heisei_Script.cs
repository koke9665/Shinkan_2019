...
public class Heisei_Script : MonoBehaviour {
	...
	void Update () {
		...
		if(Live_Time>2f){
			Instantiate (Missle,new Vector3(this.transform.position.x + 0.1f,this.transform.position.y+20f,this.transform.position.z), Quaternion.Euler(0,-90f , 0));
			Instantiate (Missle,new Vector3(this.transform.position.x + 0.1f,this.transform.position.y-20f,this.transform.position.z), Quaternion.Euler(0,-90f , 0));
			Instantiate (Missle,new Vector3(this.transform.position.x + 0.1f,this.transform.position.y,this.transform.position.z), Quaternion.Euler(0,-90f , 0));
